    ...
    <main>
        ...
        <div class="container">
            ...
            if (filter_has_var(INPUT_POST, 'btnGravar')) {
                ...
                $Usuario = new Usuario();
                $Usuario->setNomePac(filter_input(INPUT_POST, 'txtNome'));
                $Usuario->setEnderecoPac(filter_input(INPUT_POST, 'txtEndereco'));
                $Usuario->setBairroPac(filter_input(INPUT_POST, 'txtBairro'));
                $Usuario->setCidadePac(filter_input(INPUT_POST, 'txtCidade'));
                $Usuario->setEstadoPac(filter_input(INPUT_POST, 'txtEstado'));
                $Usuario->setCepPac(filter_input(INPUT_POST, 'txtCep'));
                $Usuario->setEmailPac(filter_input(INPUT_POST, 'txtEmail'));
                $Usuario->setNascimentoPac(filter_input(INPUT_POST, 'txtNascimento'));
                $Usuario->setcelularPac(filter_input(INPUT_POST, 'txtCelular'));
                    if (empty($id)){
                    $Usuario->inserir();
                }else{
